// data.js - Poprawione i zaktualizowane dane dyżurów
const dutyScheduleData = {
    // Lista przerw w ciągu dnia
    breaks: [
        "P1 (8:45-8:55)",
        "P2 (9:40-9:50)",
        "P3 (10:35-10:45)",
    ...
    // Poprawiona lista lokalizacji (10 miejsc)
    locations: [
        ...
        { name: "SG", color: "#A9A9A9" }, // Dodano nową lokalizację
        { name: "Obiad", color: "#FFC899" }
    ],

    // Zaktualizowane harmonogramy z poprawnym mapowaniem danych
    dailySchedules: {
        "poniedziałek": [
        ...
        "środa": [
            ...
            ["W. Wrzaszcz", "R. Ciszewska", "A. Szydłowska<br>A. Lorenc", "M. Szeligiewicz", "K. Jochymek", "M. Gil", "K. Jakubowska", "", "T. Zygmunt", ""],
